...
// Prompt was previously loaded from assets/prompts/02-script-generate.md (now removed).
// Inlined here for the legacy single-shot path (pipeline.useIterativeContent=false).
...
- Target a total duration of approximately ${targetSeconds} seconds (${durationMinutes} minutes). The sum of all slide durationSeconds must equal totalDurationSeconds.
